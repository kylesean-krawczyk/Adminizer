...
const DepartmentPage = () => {
  ...
  const config = departmentConfig
    ? {
        title: departmentConfig.custom_name || departmentConfig.department_id || department || '',
        description: departmentConfig.custom_description || '',
        color: departmentConfig.color_theme || 'blue',
        icon: departmentConfig.emoji || departmentConfig.icon_name || '📁',
        features: []
      }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {isAdmin && (
          <button
            onClick={() => navigate(`/settings/department-landing/${department}`)}

...
import DepartmentLandingCustomizationPage from './components/Settings/DepartmentLandingCustomizationPage'
                  ...
                  <div className="flex h-screen">
                    ...
                    <main className="flex-1 overflow-y-auto bg-white p-8 transition-all duration-300">
                      <Routes>
                        ...
                        <Route path="/settings/department-landing/:departmentId" element={
                          <ErrorBoundary fallbackMessage="The Department Customization page encountered an error. Please refresh or contact support if the problem persists.">
                            <DepartmentLandingCustomizationPage />
                          </ErrorBoundary>
                        } />
